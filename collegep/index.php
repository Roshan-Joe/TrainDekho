...
<head>
    ...
    <style>
        body {
            ...
            background: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('images/train-background.jpg');
    ...
    <main class="main-content">
        <div class="search-container">
            <div class="service-icons">
                <a href="#" class="service-icon active">
                    <img src="images/train-icon.png" alt="Train">
                    <span>Trains</span>
                </a>
                <!-- Add more service icons as needed -->
            </div>

            <form class="search-form" onsubmit="return redirectToLogin(event)">
                <div class="form-group">
                    <label>From</label>
                    <input type="text" name="from" placeholder="Enter city or station" required>
                </div>
                <div class="form-group">
                    <label>To</label>
                    <input type="text" name="to" placeholder="Enter city or station" required>
                </div>
                <div class="form-group">
        ...
        <div class="offers-section">
            ...
            <div class="offers-grid">
                ...
                <div class="offer-card">
                    <div class="offer-image">
                        <img src="images/wedding-travel.jpg" alt="Wedding Travel">
                        <span class="terms">T&C'S APPLY</span>
                    </div>
                    <div class="offer-content">
                ...
                <div class="offer-card">
                    <div class="offer-image">
                        <img src="images/trip-guarantee.jpg" alt="Trip Guarantee">
                        <span class="terms">T&C'S APPLY</span>
                    </div>
                    <div class="offer-content">
